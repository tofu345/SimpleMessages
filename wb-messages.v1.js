...
function createMessage(duration, title, content, timeout, className, svg) {
...
function createInfoMessage(
  ...
  createMessage(duration, title, content, timeout, className, svg);
}
